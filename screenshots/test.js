...
(async () => {
  ...
  await page.goto('https://8080-dcdbdadaccecefcbcaddfcbdbdfaeecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-dcdbdadaccecefcbcaddfcbdbdfaeecdcaceefaffcabd.ide.exam.ly');
